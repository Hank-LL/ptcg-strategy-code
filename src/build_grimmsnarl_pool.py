"""提出物 submission_grimmsnarl_pool.tar.gz の組み立て + 検証。

同梱物:
    main.py               = main_grimmsnarl_pool.py
    grimmsnarl_pool_heuristic.py (オーロンゲ固有ロジック)
...
使い方(~/ptcg/src で実行):
    python build_grimmsnarl_pool.py            # 組み立て + 検証
    python build_grimmsnarl_pool.py --no-test  # 組み立てのみ
"""
...
OUT = "submission_grimmsnarl_pool.tar.gz"
DECK_SRC = "../meta/top_decks/deck_marnie_grimmsnarl.csv"
POOL = "../meta/top_decks"

# (アーカイブ内の名前, コピー元)
FILES = [
    ("main.py", "main_grimmsnarl_pool.py"),
    ("grimmsnarl_pool_heuristic.py", "grimmsnarl_pool_heuristic.py"),
