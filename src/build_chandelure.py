"""提出物 submission_chandelure.tar.gz の組み立て + 検証。

同梱物:
    main.py               = main_chandelure.py
    chandelure_heuristic.py (キュワワー・ミル固有ロジック)
...
OUT = "submission_chandelure.tar.gz"
...
DECK_SRC = "../meta/top_decks/deck_chandelure.csv"
POOL = "../meta/top_decks"

# (アーカイブ内の名前, コピー元)
FILES = [
    ("main.py", "main_chandelure.py"),
    ("chandelure_heuristic.py", "chandelure_heuristic.py"),
