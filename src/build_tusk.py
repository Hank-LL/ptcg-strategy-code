"""提出物 submission_tusk.tar.gz の組み立て + 検証。

同梱物:
    main.py               = main_tusk.py
    tusk_heuristic.py (キュワワー・ミル固有ロジック)
...
# 牙2枚 + ハンドトリマー1枚。牙3枚版(deck_tusk.csv)より +3.4pp、
# エネ1枚を足す版(deck_tusk_energy.csv)より +2.4pp(12反復×384試合)。
DECK_SRC = "../meta/top_decks/deck_tusk_trimmer.csv"
POOL = "../meta/top_decks"

# (アーカイブ内の名前, コピー元)
FILES = [
    ("main.py", "main_tusk.py"),
    ("tusk_heuristic.py", "tusk_heuristic.py"),
