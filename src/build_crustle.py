"""提出物 submission_crustle.tar.gz の組み立て + 検証。

同梱物:
    main.py               = main_crustle.py
    crustle_heuristic.py (イワパレス固有ロジック)
...
使い方(~/ptcg/src で実行):
    python build_crustle.py            # 組み立て + 検証
    python build_crustle.py --no-test  # 組み立てのみ
"""
...
OUT = "submission_crustle.tar.gz"
DECK_SRC = "../meta/top_decks/deck_iwaparesu.csv"
POOL = "../meta/top_decks"

# (アーカイブ内の名前, コピー元)
FILES = [
    ("main.py", "main_crustle.py"),
    ("crustle_heuristic.py", "crustle_heuristic.py"),
